...
import { BevelHandler, CInterpHandler, ConnectionHandler, CTechHandler, Curve2dHandler, CurveHandler, DInterpHandler, FaceHandler, FreeformBmatHandler, FreeformBodyEndHandler, FreeformBodyHoleHandler, FreeformBodyParamHandler, FreeformBodyScrvHandler, FreeformBodySpHandler, FreeformBodyTrimHandler, FreeformDegreeHandler, FreeformStepHandler, FreeformTypeHandler, GeometricVertexHandler, GroupHandler, LineHandler, LodHandler, MapLibrariesHandler, MaterialLibrariesHandler, MergingGroupHandler, ObjectHandler, ParameterSpaceVertexHandler, PolygonHandler, ShadowObjectHandler, SmoothingGroupHandler, STechHandler, SurfaceHandler, TextureVertexHandler, TraceObjectHandler, UseMapHandler, UseMaterialHandler, VertexNormalHandler, type ObjDirective } from "src/obj-parser/directives/base";
